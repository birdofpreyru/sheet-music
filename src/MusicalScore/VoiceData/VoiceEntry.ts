...
export class VoiceEntry {
    ...
    public createVoiceEntriesForOrnament(
      // Note: originally it was defaulted inside the function body, using
      // if (!voiceEntryWithOrnament) check, which would thus default "null",
      // and other falsy values, not just "undefined".
