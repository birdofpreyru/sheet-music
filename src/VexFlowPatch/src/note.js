...
export class Note extends Tickable {
  ...
  constructor(noteStruct) {
    ...
    // NOTE: Done this way to avoid patching tables.js as well.
    this.minWidth = noteStruct.minWidth;
  ...
  getWidth() {
    ...
    return Math.max(this.width + (this.modifierContext ? this.modifierContext.getWidth() : 0), this.minWidth || 0);
  }
