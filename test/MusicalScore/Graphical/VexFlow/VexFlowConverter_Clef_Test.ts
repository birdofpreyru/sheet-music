...
describe("Clef Converter MusicXML to VexFlow", () => {
    ...
    function getMusicSheetWithClef(
      // NOTE: No idea, what all these unused arguments are / were intended for,
      // for now just commenting them out, and keeping them in the codebase, for
      // bookkeeping reasons.
      /*
